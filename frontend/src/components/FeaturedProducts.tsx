...
const FeaturedProducts = ({
  ...
  useEffect(() => {
    // Function to handle window resize and update items per page based on screen width for responsive design
    const handleResize = () => {
  ...
  const isStartDisabled = currentIndex === 0; // Disable the "Start" button when currentIndex is 0
  const isEndDisabled = currentIndex >= featuredProducts.length - itemsPerPage; // Disable the "End" button when currentIndex is at the end
                  ...
                  <div className="bg-gray-800 bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-emerald-500/30">
                    ...
                    <div className="p-4">
                      ...
                      <button
                        ...
                        className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-2 px-4 rounded cursor-pointer transition-colors duration-300 
