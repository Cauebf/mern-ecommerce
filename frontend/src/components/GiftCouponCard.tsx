...
const GiftCouponCard = () => {
  ...
  const handleApplyCoupon = () => {
    // Handle the apply coupon logic here
    console.log("Apply Coupon:", userInputCode);
  };

  const handleRemoveCoupon = () => {
    // Handle the remove coupon logic here
  ...
  return (
    ...
    >
      ...
      {isCouponApplied && coupon && (
        <div className="mt-4">
          ...
          <motion.button
            ...
            px-5 py-2.5 text-sm font-medium text-white cursor-pointer hover:bg-red-700 focus:outline-none
      ...
      {/* Show the available coupon for the user */}
      {coupon && (
        <div className="mt-4">
